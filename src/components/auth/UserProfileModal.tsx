  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/85 backdrop-blur-md animate-fadeIn">
      <div className="flex min-h-full items-center justify-center p-3 sm:p-6 text-center">
        <div className="relative w-full max-w-lg transform rounded-3xl glass-panel-glow border border-cyan-500/30 shadow-2xl p-5 sm:p-6 text-left bg-slate-950/95 transition-all my-6 sm:my-8">
        {/* Header */}
